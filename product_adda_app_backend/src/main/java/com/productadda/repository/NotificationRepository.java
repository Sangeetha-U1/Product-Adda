...
public interface NotificationRepository extends JpaRepository<Notification, UUID> {
    ...
    /*
     * Used by NotificationsGetMyNotificationsService (in-app
     * notification center).
     */
    ...
    /*
     * general-purpose analytics fetch, used by
     * AnalyticsAdminService and HealthCheckService (channel health).
     */
    ...
    /*
     * notification history for a user, across ALL channels.
     */
    ...
    /*
     * queue depth for liveness/readiness/HealthMonitoringWorker
     * -- count of notifications not yet in a terminal state.
     */
    long countByFkDispatchStatus_StatusNameIn(List<String> statusNames);
}
