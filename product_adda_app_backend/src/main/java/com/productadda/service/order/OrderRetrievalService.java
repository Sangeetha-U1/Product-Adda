...
import com.productadda.dto.order.OrderInvoiceSummaryDto;
...
public class OrderRetrievalService {
        ...
        public OrderDetailResponseDto getOrderById(UUID orderId) {
                ...
                List<OrderItemSummaryDto> itemSummaries = orderItemRepository.findByFkOrderAndIsActiveTrue(order)
                                ...
                                .map(item -> OrderItemSummaryDto.builder()
                                                ...
                                                .productId(item.getFkProduct() != null
                                                                ...
                                                                : null)
                                                .vendorId(item.getFkVendor() != null
                                                                ? item.getFkVendor().getPkVendorId()
                                                                : null)
                ...
                Invoice invoice = invoiceRepository
                                .findByFkOrder_PkOrderId(order.getPkOrderId())
                                .orElse(null);
                ...
                OrderCouponSummaryDto couponSummary = coupon == null ? null
                ...
                OrderPaymentSummaryDto paymentSummary = payment == null ? null
                ...
                OrderInvoiceSummaryDto invoiceSummary = invoice == null ? null
                                : OrderInvoiceSummaryDto.builder()
