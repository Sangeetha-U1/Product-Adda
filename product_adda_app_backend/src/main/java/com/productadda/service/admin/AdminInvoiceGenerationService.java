...
import com.productadda.service.invoice.InvoicePdfRenderer;
import com.productadda.service.invoice.InvoiceStorageService;
...
public class AdminInvoiceGenerationService {
        ...
        /*
         * ================================================================
         * SECURE ADMINISTRATIVE INVOICE GENERATION OR UPDATE
         ...
         * Enforces strict Level-2 Zero-Trust validation by checking database user roles
         * to
         * guarantee that only identities containing an explicit ADMIN or SUPER_ADMIN
         * record
         * can trigger or update these records.
         * ================================================================
         */
        @Transactional
        public InvoiceResponseDto adminGenerateInvoice(UUID orderId) {
                ...
                if (orderId == null) {
                        throw new ApiException(HttpStatus.BAD_REQUEST,
                                        "Order id is required for administrative processing");
                }
                ...
                User currentUser = userRepository.findByEmail(currentUsername)
                                .orElseThrow(() -> new ApiException(HttpStatus.NOT_FOUND,
                                                "Authenticated admin user no longer exists"));
                ...
                if (userRoles.isEmpty()) {
                        throw new ApiException(HttpStatus.FORBIDDEN,
                                        "User lacks privileges to execute administrative generation workflows");
                }
                ...
                // Strict Level-2 Guardrail Check: Reject processing if the database-backed role
                // data
                // does not map explicitly to ADMIN or SUPER_ADMIN authorization parameters.
                if (!isAdminOrSuperAdmin) {
                        throw new ApiException(HttpStatus.FORBIDDEN,
                                        "Access denied. Insufficient database privileges to trigger compilation operations");
                }
                 ...
                 * ================================================================
                 */
                // String activePresignedUrl =
                // invoiceStorageService.generatePresignedUrl(savedInvoice.getObjectKey(),
