...
public class AdminUserCreateService {
        ...
        public AdminUserCreateResponseDto createAdminUser(AdminUserCreateRequestDto request,
                ...
                /*
                 * ================================================================
                 * 2. ROLE HIERARCHY SECURITY GUARD
                 * ================================================================
                 */
                ...
                /*
                 * ================================================================
                 * 3. BUSINESS RULES & DB PERSISTENCE
                 * ================================================================
                 */
                ...
                // Modified: Kept initial creation safe and secure (.emailVerified(false) &
                // .isActive(false))
                ...
                /*
                 * ================================================================
                 * 3.5 EMAIL VERIFICATION ENGINE WORKFLOW
                 * ================================================================
                 */
