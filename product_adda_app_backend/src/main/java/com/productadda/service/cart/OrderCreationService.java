...
public class OrderCreationService {
    ...
    public Order createOrder(
        ...
        if (user == null || cart == null || cartItems == null || cartItems.isEmpty()
                || address == null || pendingStatus == null || totals == null || idempotencyKey == null) {
        ...
        for (CartItem cartItem : cartItems) {
            ...
            OrderItem orderItem = OrderItem.builder()
                    ...
                    .lineTotal(cartItem.getPriceAtAdd().multiply(java.math.BigDecimal.valueOf(cartItem.getQuantity())))
                    .isActive(true)
                    .build();
