...
INSERT INTO products (pk_product_id, fk_vendor_id, fk_category_id, fk_brand_id, fk_status_id, title, description, sku, price, discount_price, average_rating, total_reviews, is_active, created_at_utc) VALUES
(UUID_V7(), (SELECT pk_vendor_id FROM vendors WHERE store_name = 'Tech Solutions Store'), (SELECT pk_category_id FROM categories WHERE category_name = 'Mobile Phones'), (SELECT pk_brand_id FROM brands WHERE brand_name = 'Samsung'), (SELECT pk_status_id FROM product_status_lookup WHERE status_code = 'APPROVED'), 'Samsung Galaxy S24 Ultra', 'Samsung flagship smartphone', 'MOB-SAMSUNG-S24-001', 129999.00, 124999.00, 4.80, 125, TRUE, '2025-03-10 10:00:00'),
(UUID_V7(), (SELECT pk_vendor_id FROM vendors WHERE store_name = 'Tech Solutions Store'), (SELECT pk_category_id FROM categories WHERE category_name = 'Laptops'), (SELECT pk_brand_id FROM brands WHERE brand_name = 'Dell'), (SELECT pk_status_id FROM product_status_lookup WHERE status_code = 'APPROVED'), 'Dell XPS 15', 'Premium performance laptop', 'LAP-DELL-XPS15-001', 159999.00, 149999.00, 4.70, 84, TRUE, '2025-07-22 14:30:00'),
(UUID_V7(), (SELECT pk_vendor_id FROM vendors WHERE store_name = 'Fashion Hub Store'), (SELECT pk_category_id FROM categories WHERE category_name = 'Men Clothing'), (SELECT pk_brand_id FROM brands WHERE brand_name = 'Nike'), (SELECT pk_status_id FROM product_status_lookup WHERE status_code = 'APPROVED'), 'Nike Sports T-Shirt', 'Breathable sports t-shirt', 'MEN-NIKE-TSHIRT-001', 1999.00, 1499.00, 4.50, 43, TRUE, '2025-11-05 09:15:00');
