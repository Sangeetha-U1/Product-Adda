...
(
    ...
    gateway_error_code VARCHAR(100) NULL,
    ...
    CONSTRAINT chk_payments_amount_positive CHECK (amount_in_paise >= 0),
    CONSTRAINT chk_payments_fee_positive CHECK (fee_in_paise >= 0),
    CONSTRAINT chk_payments_tax_positive CHECK (tax_in_paise >= 0),
