...
Maintains product snapshot information even if product changes later, and tracks
vendor assignments alongside calculated line-item revenue.
===============================================================================
*/
...
(
    ...
    CONSTRAINT pk_order_items_order_item_id PRIMARY KEY (pk_order_item_id),
...
CREATE INDEX idx_order_items_order ON order_items(fk_order_id);
CREATE INDEX idx_order_items_product ON order_items(fk_product_id);
CREATE INDEX idx_order_items_vendor ON order_items(fk_vendor_id);
